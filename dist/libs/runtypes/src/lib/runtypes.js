...
const encodeUser = (_u) => ({ _tag: 'left', error: 'the lib cannot do it' });
exports.encodeUser = encodeUser;
// utils
const mapResult = (r) => r.success ? { _tag: 'right', value: r.value } : { _tag: 'left', error: r.message /*todo code, details*/ };
