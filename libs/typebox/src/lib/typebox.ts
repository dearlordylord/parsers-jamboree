...
const SubscriptionType = Type.Union(SUBSCRIPTION_TYPES.map(c => Type.Literal(c)))

type StripeIdBrand = {
  readonly StripeId: unique symbol;
}

const StripeId = Type.Transform(Type.String({
...
const Email = Type.Transform(Type.String({
